...
from mgraph_ai_service_js.config                                  import SERVICE_NAME, LAMBDA_DEPENDENCIES__FAST_API_SERVERLESS
from mgraph_ai_service_js.fast_api.lambda_handler                 import run
